            ...
            courseList.map((uni, idx) =>
              <> {((uni.courseCategory === active) || active === "All") &&
                <Card style={{ width: '25rem', maxWidth: '95vw' }} className='m-2' key={idx}>
                  ...
                  {uni.contact && <button style={{ background: "none", border: "none", position: "absolute", right: "5px", bottom: "10px" }} onClick={() => { window.open(`https://www.linkedin.com/in/${uni.contact.profile}/`, "_blank") }}>
